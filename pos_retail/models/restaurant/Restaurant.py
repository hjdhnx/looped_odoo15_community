...
class RestaurantTable(models.Model):
    ...
    table_pos_config_id = fields.Many2one('pos.config',string="Point of Sale",related="floor_id.table_pos_config_id")
...
class RestaurantTable(models.Model):
    ...
    viewport_h = fields.Integer('')
    viewport_w = fields.Integer('')
    table_pos_config_id = fields.Many2one('pos.config',string="Table Point of Sale")
