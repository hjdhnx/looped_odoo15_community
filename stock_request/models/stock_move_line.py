...
class StockMoveLine(models.Model):
    ...
    def create(self,vals):
        ...
        if self._context.get('stock_request_order_id',False):
            res.stock_request_order_id = self._context.get('stock_request_order_id',False)
        print(">>>>>>>>>>>>>>>>>>>>...RES",res.stock_request_order_id)
