...
class PettyPayWizard(models.TransientModel):
    ...
    payment_method_id = fields.Many2one('account.payment.method', string='Payment Type', required=False)
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Type', required=True)
    ...
    def _compute_hide_payment_method(self):
        if not self.journal_id:
            ...
            return
        journal_payment_methods = self.journal_id.outbound_payment_method_line_ids #outbound_payment_method_ids
    ...
    def _onchange_journal(self):
        if self.journal_id:
            ...
            payment_methods = self.journal_id.outbound_payment_method_line_ids #outbound_payment_method_ids
            # self.payment_method_id = payment_methods and payment_methods[0] or False
            self.payment_method_line_id = payment_methods and payment_methods[0] or False
            # Set payment method domain (restrict to methods enabled for the journal and to selected payment type)
            # return {
            #     'domain': {'payment_method_line_id': [('payment_type', '=', 'outbound'), ('id', 'in', payment_methods.ids)]}}
        return {}
