...
//            self.ks_fetch_data();
        ...
        onKsDuplicateItemClick: function(e) {
            ...
            this._rpc({
                ...
                var msg = _t('Selected item is duplicated to ' + dashboard_name + ' .')
                self.displayNotification({ title: _t("Item Duplicated"), message: msg });
                $.when(self.ks_fetch_data()).then(function () {
        ...
        onKsMoveItemClick: function(e) {
            ...
            this._rpc({
                ...
                var msg = _t('Selected item is moved to ' + dashboard_name + ' .');
                self.displayNotification({ title: _t("Item Moved"), message: msg });
                $.when(self.ks_fetch_data()).then(function() {
